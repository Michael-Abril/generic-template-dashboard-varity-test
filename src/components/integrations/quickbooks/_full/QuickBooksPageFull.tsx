...
// Import full-featured sub-components
import QuickBooksDashboard from './QuickBooksDashboardFull';
import InvoicesList from './InvoicesListFull';
import CustomersList from './CustomersList';
import ExpensesList from './ExpensesListFull';
