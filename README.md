...
| Provider | Status | Priority | Portal |
|----------|--------|----------|--------|
| QuickBooks | Configured | - | developer.intuit.com |
| Google Workspace | **Needs Credentials** | 1 | console.cloud.google.com |
| Microsoft 365 | **Needs Credentials** | 2 | portal.azure.com |
| Slack | **Needs Credentials** | 3 | api.slack.com |
| HubSpot | Not Started | 4 | developers.hubspot.com |
| Zendesk | Not Started | 5 | developer.zendesk.com |
| Salesforce | Not Started | 6 | developer.salesforce.com |

### Redirect URIs (Update after deployment)
